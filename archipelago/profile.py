...
class ArchipelagoProfiler(object):
    ...
    def store_generating_model_parameters(self, generating_model, profile_results):
        ...
        profile_results["lineage.birth.rate.definition"] = generating_model.lineage_birth_weight_function.definition_content
        profile_results["lineage.birth.rate.description"] = generating_model.lineage_birth_weight_function.description
        profile_results["lineage.death.rate.definition"] = generating_model.lineage_death_weight_function.definition_content
        profile_results["lineage.death.rate.description"] = generating_model.lineage_death_weight_function.description
