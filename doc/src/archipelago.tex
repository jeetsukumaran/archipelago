...
\begin{description}
    ...
    \item[``diversification'']  \hfill \\
        ...
        \begin{description}
            \item[``mean\_diversification\_birth\_rate'':] \hfill \\
            ...
            \item[``lineage\_birth\_weight'':] \hfill \\
                ...
                This will be normalized across the phylogeny to maintain the birth rate given by \textit{mean\_diversification\_birth\_rate}.
            \item[``mean\_diversification\_death\_rate'':] \hfill \\
            ...
            \item[``lineage\_death\_weight'':] \hfill \\
                ...
                This will be normalized across the phylogeny to maintain the death rate given by \textit{mean\_diversification\_death\_rate}.
        \end{description}
...
\begin{lstlisting}
"diversification": {
    "mean\_diversification\_birth\_rate": 0.05486829846551938,
    "mean\_diversification\_death\_rate": 0.0
},\end{lstlisting}
...
"anagenetic_range_evolution": {
    "global\_area\_gain\_rate": 0.018156246,
    .
    .
    ,
\end{lstlisting}
