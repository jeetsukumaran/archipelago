...
To \hyperref[sec:workflow-calculation-of-summary-statistics]{calculate the summary statistics} or \hyperref[sec:workflow-profiking-the-target-data]{profile the target data} using \archipelagoPackage the target phylogeny needs to be encoded with the geographical and trait information.
This can
...
The \archipelagoPackage package provides a program, ``\textit{archipelago-profile.py}'' that conveniently does this for you.
It
