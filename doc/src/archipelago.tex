...
While not a mandatory argument, explicitly specifying the output filenames using the ``\texttt{-o}'' or ``\texttt{--output-filepath}'' argument is a good idea; otherwise, output gets written to the standard output instead of being saved to a file.
