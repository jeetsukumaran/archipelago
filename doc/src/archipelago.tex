...
\begin{itemize}
    ...
    \begin{itemize}
        \item adegenet
    \end{itemize}
    \item To ``calibrate'' the simulation biogeographical submodel, you need to estimate the dispersal and extinction rate under the DEC or a DEC-like model:
    \begin{itemize}
        \item lagrange
        \item BayArea
        \item RevBayes
    ...
    \end{itemize}
    \item While to ``calibrate'' the simulation trait evolution submodel, you need to estimate the trait evolution rate:
    \begin{itemize}
        \item GEIGER
    \end{itemize}
\end{itemize}
